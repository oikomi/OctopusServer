...
func FixLen(base libnet.Protocol, n int, byteOrder binary.ByteOrder, maxRecv, maxSend int) *FixLenProtocol {
...
func (p *FixLenProtocol) NewCodec(rw io.ReadWriter) (cc libnet.Codec, err error) {
	codec := &fixlenCodec{
		rw:             rw,
		FixLenProtocol: p,
	}
